    ...
    <div className="who-we-are-section">
      <Row gutter={[16, 16]}>
        ...
        <Col xs={24} md={12} className="left-column">
          <Title level={2} className="text-center">Who We Are</Title>
        ...
        <Col xs={24} md={12} className="right-column">
          <Title level={2} className="text-center">Messages</Title>
          <div className="message-item flex items-center mb-4">
            <Avatar src="https://via.placeholder.com/150" size={64} />
            <div className="ml-4">
